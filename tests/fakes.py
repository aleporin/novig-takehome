...
class FakeLLMClient:
    ...
    def __init__(self, responses: list[BaseModel | str | Exception] | None = None) -> None:
        self._queue: list[BaseModel | str | Exception] = list(responses or [])
        self.calls: list[LLMRequest] = []

    def queue(self, item: BaseModel | str | Exception) -> FakeLLMClient:
